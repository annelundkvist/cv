...
export function Home(){
    return(
        <div className={"Home scroll-offset"} id="home">
            ...
            <h2> Engageret, målrettet og nysgerrig sundhedsteknologiingeniør søger arbejde</h2>
            ...
            <br /> <br />
            Med mit store drive, positive tilgang og lyst til at lære nyt er jeg klar til at tage det næste skridt og udvikle mig yderligere i en rolle, hvor jeg kan arbejde videre med mine interesser for UX eller softwareudvikling, eller i en kombination.</p>
